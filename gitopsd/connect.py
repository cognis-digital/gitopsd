"""Native cognis-connect emit for gitopsd — forward findings to any platform.

Maps gitopsd's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    gitopsd ... --format json | gitopsd-emit --to stix
    gitopsd-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
